...
import { c as usePage, b as loadLanguageAsync } from "../ssr.js";
import { u as useLocales } from "./useLocales-C-Tc7ETb.js";
      ...
      if (unref(hasMultipleLocales)) {
        ...
        _push(ssrRenderComponent(unref(Menu), null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(MenuButton), { class: "py-2 uppercase inline-flex items-center rounded-lg" }, {
              ...
              return [
                createVNode(unref(MenuButton), { class: "py-2 uppercase inline-flex items-center rounded-lg" }, {
                  default: withCtx(() => [
                    createVNode("span", null, toDisplayString(unref(currentMappedLocale)), 1),
                    createVNode(unref(IconChevronDown), { stroke: "{2}" })
                  ]),
