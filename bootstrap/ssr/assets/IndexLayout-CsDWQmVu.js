...
import { c as usePage, h as head_default } from "../ssr.js";
import { _ as _sfc_main$9 } from "./Breadcrumbs-BaC6CclY.js";
import { IconCategory, IconX, IconHomeFilled, IconHome, IconCategoryFilled } from "@tabler/icons-vue";
import { _ as _sfc_main$6 } from "./ApplicationLogo-ClfPV3Yy.js";
import { defineStore } from "pinia";
import { u as useApiResourceService } from "./useApiResourceService-BibiLDfj.js";
import { _ as _sfc_main$7, S as SerchContainer, a as _sfc_main$8 } from "./UserLoginRegisterForm-CE0XGaOj.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Link = resolveComponent("Link");
      _push(`<!--[--><div data-v-8487a9b8><div class="container mx-auto px-2" data-v-8487a9b8><nav class="flex gap-4 md:gap-6 py-3" data-v-8487a9b8>`);
      _push(ssrRenderComponent(_component_Link, {
        href: "/",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="" data-v-8487a9b8${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, { class: "w-10 h-10 bg-brand fill-current" }, null, _parent2, _scopeId));
            _push2(`</div><span class="font-semibold hidden md:block" data-v-8487a9b8${_scopeId}>${ssrInterpolate(_ctx.$page.props?.app?.name)}</span>`);
          } else {
            return [
      ...
      _push(`<div class="md:relative z-[60] flex flex-col flex-grow" data-v-8487a9b8>`);
      _push(ssrRenderComponent(_sfc_main$7, {
        onFocus: hadleFocus,
        onSearch: ($event) => goSearch($event)
      }, null, _parent));
      if (inputFocus.value) {
        _push(`<div data-v-8487a9b8>`);
      ...
      _push(`</div><div class="hidden md:flex items-center gap-4" data-v-8487a9b8>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="md:hidden fixed bottom-0 left-0 w-full p-2" data-v-8487a9b8><div class="flex gap-6 items-center justify-center bg-white p-2 shadow-lg rounded-full" data-v-8487a9b8>`);
        _push2(ssrRenderComponent(_component_Link, {
          ...
          default: withCtx((_, _push3, _parent2, _scopeId) => {
            if (_push3) {
              ...
              _push3(`<span class="text-xs font-semibold tracking-tight" data-v-8487a9b8${_scopeId}>${ssrInterpolate(_ctx.$t("Home"))}</span>`);
            } else {
              return [
        ...
        _push2(`<button class="${ssrRenderClass([{ "text-brand": mobileCatalogMenu.value }, "flex flex-col items-center"])}" data-v-8487a9b8>`);
        if (!mobileCatalogMenu.value) {
        ...
        _push2(`<span class="text-xs font-semibold tracking-tight" data-v-8487a9b8>${ssrInterpolate(_ctx.$t("Catalog"))}</span></button>`);
        _push2(ssrRenderComponent(_sfc_main$8, null, null, _parent));
        _push2(`</div></div>`);
        if (catalogMenu.value || inputFocus.value) {
          _push2(`<div class="fixed inset-0 bg-black/10 z-[10]" data-v-8487a9b8></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const NavComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8487a9b8"]]);
const _sfc_main = {
  __name: "IndexLayout",
  __ssrInlineRender: true,
  setup(__props) {
