import { ref, reactive, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, isRef, Transition, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode(_sfc_main$5, {
                            ...
                            errors: __props.errors,
                            "is-editing": isEditing.value
                          }, null, 8, ["modelValue", "onUpdate:modelValue", "errors", "is-editing"])
                        ];
                      }
                    }),
                    _: 1
      ...
      if (_ctx.$page.props.app.mode === "local") {
        _push(`<section>`);
        _push(ssrRenderComponent(_sfc_main$6, { data: unref(form) }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Manufacturers/Edit.vue");
