...
import _sfc_main$3 from "./DataForm-YAJ8z_Ra.js";
import _sfc_main$2 from "./SEOForm-BvRWdGLK.js";
import _sfc_main$1 from "./GeneralForm-DqbuB5Ed.js";
import { _ as _sfc_main$5 } from "./StickyActions-DFSqE-gR.js";
import { _ as _sfc_main$6 } from "./ButtonTabGroup-DbwGHxsz.js";
import _sfc_main$4 from "./MediaForm-CHxeVoAB.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleSave = () => {
      const url = props.isEditing ? route(`${props.routePrefix}.update`, props.data?.brand?.id) : route(`${props.routePrefix}.store`);
      router.post(
        url,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        title: props.isEditing ? props.data?.brand?.title ?? _ctx.$t("Brand details") : _ctx.$t("New brand"),
        description: props.isEditing ? _ctx.$t("Brand details and settings management") : _ctx.$t(
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Brands/Components/BrandForm.vue");
