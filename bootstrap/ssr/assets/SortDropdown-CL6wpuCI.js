      ...
      _push(ssrRenderComponent(unref(Listbox), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(ListboxButton), { class: "flex items-center gap-2 border p-2 rounded-full text-sm w-48 text-left" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(_ctx.$t(currentLabel.value))}`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(unref(ListboxOptions), { class: "absolute mt-1 w-48 bg-white rounded-xl shadow-lg z-10 text-sm p-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
            ...
            return [
              createVNode("div", { class: "relative" }, [
                createVNode(unref(ListboxButton), { class: "flex items-center gap-2 border p-2 rounded-full text-sm w-48 text-left" }, {
                  default: withCtx(() => [
                    createVNode(unref(IconArrowsDownUp), {
                      stroke: 2,
                      class: "w-4 h-4"
                ...
                createVNode(unref(ListboxOptions), { class: "absolute mt-1 w-48 bg-white rounded-xl shadow-lg z-10 text-sm p-2" }, {
                  default: withCtx(() => [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.options, (option) => {
                      return openBlock(), createBlock(unref(ListboxOption), {
                        key: option.value,
