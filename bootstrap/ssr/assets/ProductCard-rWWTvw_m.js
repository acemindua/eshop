...
import _sfc_main$3 from "./QuantityStatus-DsGBQWeE.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (hasDiscount.value && __props.data.quantity > 0) {
        _push(`<div class="absolute top-4 left-4 z-30 bg-white/20 border border-red-500 text-red-500 text-[12px] uppercase font-bold px-2 py-1 rounded-sm"><span>-${ssrInterpolate(discountPercentage.value)}%</span></div>`);
      } else {
        _push(`<!---->`);
      }
