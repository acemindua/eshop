import { ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, Transition, useSSRContext } from "vue";
...
import DataForm from "./DataForm-CHnfIpJK.js";
import _sfc_main$4 from "./GeneralForm-9N_H0Q63.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    const handleSave = () => {
      router.post(route("admin.orders.store"), form, {
        forceFormData: true,
        preserveState: true,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Orders/Create.vue");
