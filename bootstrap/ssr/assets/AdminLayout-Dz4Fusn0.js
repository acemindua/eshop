import { computed, unref, mergeProps, withCtx, createVNode, renderSlot, Transition, openBlock, createBlock, createCommentVNode, useSSRContext, resolveDirective, resolveDynamicComponent, ref, watch, useModel, resolveComponent } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderVNode, ssrInterpolate, ssrRenderStyle } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSidebarVisible.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-40 md:hidden transition-opacity duration-300" data-v-d3e40d89></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-slate-200 w-full min-h-screen" data-v-d3e40d89><div class="flex w-full h-full relative" data-v-d3e40d89><aside class="${ssrRenderClass([[
        isSidebarVisible.value ? "hidden md:flex relative" : "flex absolute h-full"
      ], "border-r dark:border-slate-800 dark:shadow-2xl"])}" data-v-d3e40d89><div class="bg-gray-50 dark:bg-slate-900 flex flex-col z-[60]" data-v-d3e40d89>`);
      _push(ssrRenderComponent(_sfc_main$2, null, null, _parent));
      _push(`</div><button class="bg-white dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 transition-all duration-150 absolute z-[60] top-11 -right-3 w-6 h-6 border dark:border-slate-600 rounded-full flex items-center justify-center" data-v-d3e40d89>`);
      ...
      if (_ctx.$slots.sidenav) {
        _push(`<div class="w-60 border-l dark:border-slate-800 bg-white dark:bg-slate-900 z-50 relative" style="${ssrRenderStyle(isSecondarySidebarVisible.value ? null : { display: "none" })}" data-v-d3e40d89>`);
        ssrRenderSlot(_ctx.$slots, "sidenav", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</aside><div class="flex flex-col w-full h-screen overflow-y-auto" data-v-d3e40d89><header class="w-full h-14 border-b text-xs text-gray-600 dark:text-slate-300 dark:border-slate-700" data-v-d3e40d89><div class="px-2 md:px-4 lg:px-8 h-full" data-v-d3e40d89><div class="flex justify-between items-center h-full space-x-2 border-l border-r" data-v-d3e40d89><div class="flex items-center" data-v-d3e40d89><button class="group inline-flex md:hidden p-2 text-slate-800 dark:text-slate-200 items-center justify-center rounded transition" data-v-d3e40d89><svg class="w-6 h-6 fill-current" viewBox="0 0 16 16" data-v-d3e40d89><rect class="origin-center" y="3" width="16" height="2" rx="1" data-v-d3e40d89></rect><rect class="origin-center" y="7" width="16" height="2" rx="1" data-v-d3e40d89></rect><rect class="origin-center" y="11" width="16" height="2" rx="1" data-v-d3e40d89></rect></svg></button><div class="p-2 ml-2" data-v-d3e40d89><h1 class="font-semibold text-gray-800 dark:text-slate-300 text-base" data-v-d3e40d89>${ssrInterpolate(title.value)}</h1>`);
      ...
      _push(`</div></div></header><main class="flex-grow" data-v-d3e40d89>`);
      _push(ssrRenderComponent(AlertMessage, null, null, _parent));
      _push(`<div class="px-2 md:px-4 lg:px-8 w-full h-full" data-v-d3e40d89><template><div class="border-l border-r h-full p-4" data-v-d3e40d89>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></template></div></main><footer class="text-xs text-gray-600 dark:text-slate-400 border-t dark:border-slate-700" data-v-d3e40d89><div class="px-2 md:px-4 lg:px-8" data-v-d3e40d89><p class="text-center md:text-end border-l border-r h-full p-4" data-v-d3e40d89> © ${ssrInterpolate(unref(currentYear))} ${ssrInterpolate(_ctx.$page.props.app.name)}. Version ${ssrInterpolate(_ctx.$page.props.app.version)}</p></div></footer></div></div></div><!--]-->`);
    };
  }
};
...
const AdminLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d3e40d89"]]);
export {
  AdminLayout as A,
  _sfc_main$4 as _
};
