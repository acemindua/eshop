...
import { _ as _sfc_main$4 } from "./DefaultLayout-Jakv3XrT.js";
import "@vue/shared";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="p-2 flex flex-col flex-grow"><h3 class="text-gray-800 transition-colors group-hover:text-brand line-clamp-2 h-12">${ssrInterpolate(__props.data.title)}</h3><div class="h-8 flex w-full items-center justify-start text-xs mt-2">`);
