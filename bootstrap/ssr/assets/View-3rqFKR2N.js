...
import { _ as _sfc_main$4, a as _sfc_main$5, M as MediaSlider } from "./SeoMeta-DM-OmeWN.js";
import { computed, mergeProps, unref, useSSRContext, ref, reactive, watch, onMounted } from "vue";
import { A as AuthModal } from "./AuthModal-C4QAXByT.js";
...
import { _ as _sfc_main$6 } from "./DefaultLayout-DbG3NCf7.js";
...
import _sfc_main$8 from "./QuantityStatus-DsGBQWeE.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (hasDiscount.value) {
        _push(`<div class="bg-white p-4"><div class="flex items-center"><div class="border border-red-500 text-red-500 text-[12px] font-bold px-2 py-1 rounded-sm"> -${ssrInterpolate(discountPercentage.value)}% </div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Public/Commerce/Pages/View.vue");
