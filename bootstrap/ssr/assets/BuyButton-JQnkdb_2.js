...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d0626f64><div class="shine-effect" data-v-d0626f64></div>`);
      ...
      _push(`<span class="hidden md:block" data-v-d0626f64>${ssrInterpolate(isInCart.value ? _ctx.$t("In Cart") : _ctx.$t("Buy"))}</span></button>`);
    };
  }
};
...
const BuyButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d0626f64"]]);
export {
