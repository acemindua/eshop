...
import { _ as _sfc_main$4, P as Pagination } from "./BadgeStatus-CuMJsa-m.js";
import { _ as _sfc_main$1 } from "./Checkbox-BYIkH8i_.js";
import { _ as _sfc_main$2 } from "./ImageDataView-C9GsQUU8.js";
import { _ as _sfc_main$3 } from "./UserStatus-DfjMQc-4.js";
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-x-auto border bg-white rounded-lg" }, _attrs))}><table class="w-full text-sm min-w-[500px]"><thead><tr class="text-xs uppercase text-slate-600 text-thin divide-x"><th class="p-3 w-12">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        class: "mx-auto",
        checked: toggleAll.value,
        "onUpdate:checked": ($event) => toggleAll.value = $event
      }, null, _parent));
      _push(`</th><th class="p-3 text-center w-24">#</th><th class="py-3 text-center w-24">${ssrInterpolate(_ctx.$t("ava"))}</th><th class="p-3 text-start w-full md:w-auto">${ssrInterpolate(_ctx.$t("Title"))}</th><th class="p-3 text-center w-48">${ssrInterpolate(_ctx.$t("Status"))}</th><th class="p-3 w-48">`);
      ...
      if (__props.items.length > 0) {
        ...
        ssrRenderList(__props.items, (item, key) => {
          ...
          _push(`</td><td class="p-2 text-center text-gray-500">${ssrInterpolate(_ctx.$formatSerial(count.value + key))}</td><th class="p-1"><div class="relative flex items-center justify-center mb-2 w-12 h-12 mx-auto">`);
          _push(ssrRenderComponent(_sfc_main$2, {
            src: item?.avatar,
            configs: { width: "36px", height: "36px" }
          }, null, _parent));
          _push(`<div class="absolute bottom-1 right-1 border-0 rounded-full w-5 h-5 flex items-center justify-center bg-white">`);
          _push(ssrRenderComponent(_component_flag, {
            iso: item?.preferred_locale || "gb",
            title: item?.preferred_locale,
            class: "rounded-full"
          }, null, _parent));
          _push(`</div></div></th><td class="p-2"><div class="flex flex-col"><p class="font-semibold">${ssrInterpolate(item.name)}</p>`);
          ...
          _push(`</div></td><td class="p-2"><div class="flex justify-center">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Users/Partials/DataTable.vue");
