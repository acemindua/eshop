...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Додати склад" }, null, _parent));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.app.mode === "local") {
              ...
              _push2(ssrRenderComponent(_sfc_main$6, { data: unref(form) }, null, _parent2, _scopeId));
              _push2(`</section>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "py-12" }, [
                ...
                _ctx.$page.props.app.mode === "local" ? (openBlock(), createBlock("section", { key: 0 }, [
                  createVNode(_sfc_main$6, { data: unref(form) }, null, 8, ["data"])
