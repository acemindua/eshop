...
import _sfc_main$3 from "./DataForm-BUKIS5db.js";
import _sfc_main$2 from "./SEOForm-C8A91PPK.js";
import _sfc_main$1 from "./GeneralForm-yINx4z3W.js";
import { _ as _sfc_main$5 } from "./StickyActions-DFSqE-gR.js";
import { _ as _sfc_main$6 } from "./ButtonTabGroup-DbwGHxsz.js";
import _sfc_main$4 from "./MediaForm-BK8PJhWn.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleSave = () => {
      const url = props.isEditing ? route(`${props.routePrefix}.update`, props.data?.category?.id) : route(`${props.routePrefix}.store`);
      router.post(
        url,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, {
        ...
        title: props.isEditing ? props.data?.category?.title ?? _ctx.$t("Category details") : _ctx.$t("New category"),
        description: props.isEditing ? _ctx.$t("Category details and settings management") : _ctx.$t(
          "Category creation form with all necessary details and settings"
        )
      }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Categories/Components/CategoryForm.vue");
