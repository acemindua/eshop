    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.items.length > 0) {
        ...
        ssrRenderList(__props.items, (item, key) => {
          ...
          _push(`</td><td class="p-2 text-center text-gray-500">${ssrInterpolate(_ctx.$formatSerial(count.value + key))}</td><th class="p-1">`);
          _push(ssrRenderComponent(_sfc_main$2, {
            src: item?.avatar,
            configs: { width: "36px", height: "36px" }
          }, null, _parent));
          _push(`</th><td class="p-2"><div class="flex flex-col"><p class="font-semibold">${ssrInterpolate(item.name)}</p>`);
