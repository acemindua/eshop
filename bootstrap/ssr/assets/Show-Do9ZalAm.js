...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ButtonsGroup = resolveComponent("ButtonsGroup");
      ...
      _push(ssrRenderComponent(_component_ButtonsGroup, { buttons: _ctx.actionButtons }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Pages/Show.vue");
