...
import { IconLoader2, IconShoppingBagCheck, IconShoppingBagPlus } from "@tabler/icons-vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-51c5b0e1><div class="shine-effect" data-v-51c5b0e1></div>`);
      if (isProcessing.value) {
        _push(ssrRenderComponent(unref(IconLoader2), { class: "w-6 h-6 animate-spin" }, null, _parent));
      } else {
        _push(`<!--[-->`);
        if (isInCart.value) {
          ...
          _push(ssrRenderComponent(unref(IconShoppingBagPlus), {
            stroke: 2,
            class: "w-6 h-6"
          }, null, _parent));
        }
      ...
      _push(`<span class="hidden md:block" data-v-51c5b0e1>${ssrInterpolate(isInCart.value ? _ctx.$t("In Cart") : _ctx.$t("Buy"))}</span></button>`);
    };
  }
};
...
const BuyButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-51c5b0e1"]]);
export {
