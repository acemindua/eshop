  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { class: "flex flex-col text-xs font-semibold text-gray-600" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="flex items-center leading-6 mb-1.5"${_scopeId}>${ssrInterpolate(_ctx.$t("Manufacturer"))}</span>`);
            ...
            return [
              createVNode("span", { class: "flex items-center leading-6 mb-1.5" }, toDisplayString(_ctx.$t("Manufacturer")), 1),
      ...
      _push(ssrRenderComponent(_sfc_main$1, { class: "flex flex-col text-xs font-semibold text-gray-600" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="flex items-center leading-6 mb-1.5"${_scopeId}>${ssrInterpolate(_ctx.$t("Parent category"))}</span>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
            ...
            return [
              createVNode("span", { class: "flex items-center leading-6 mb-1.5" }, toDisplayString(_ctx.$t("Parent category")), 1),
              createVNode(_sfc_main$5, {
                modelValue: __props.form.category_id,
                "onUpdate:modelValue": ($event) => __props.form.category_id = $event,
                items: __props.data.categories?.data || [],
