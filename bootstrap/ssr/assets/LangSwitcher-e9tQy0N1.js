      ...
      if (unref(hasMultipleLocales)) {
        ...
        _push(ssrRenderComponent(unref(Menu), null, {
          default: withCtx(({ open }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(MenuButton), { class: "rounded-full pl-2 py-[2px] bg-gray-100 uppercase font-semibold text-gray-500 inline-flex items-center" }, {
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(unref(IconChevronDown), {
                      class: ["transition-transform text-gray-600 duration-200 w-4 h-4", open ? "rotate-180" : ""],
                      stroke: 1
              ...
              return [
                createVNode(unref(MenuButton), { class: "rounded-full pl-2 py-[2px] bg-gray-100 uppercase font-semibold text-gray-500 inline-flex items-center" }, {
                  default: withCtx(() => [
                    createVNode("span", null, toDisplayString(unref(currentMappedLocale)), 1),
                    createVNode(unref(IconChevronDown), {
                      class: ["transition-transform text-gray-600 duration-200 w-4 h-4", open ? "rotate-180" : ""],
