  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSidebarVisible.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-40 md:hidden transition-opacity duration-300" data-v-c9e124b9></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-slate-200 w-full min-h-screen" data-v-c9e124b9><div class="flex w-full h-full relative" data-v-c9e124b9><aside class="${ssrRenderClass([[
        isSidebarVisible.value ? "hidden md:flex relative" : "flex absolute h-full"
      ], "border-r dark:border-slate-800 dark:shadow-2xl"])}" data-v-c9e124b9><div class="bg-gray-100 flex flex-col z-[60]" data-v-c9e124b9>`);
      ...
      if (_ctx.$slots.sidenav) {
        _push(`<div class="w-[200px] border-l dark:border-slate-800 bg-white dark:bg-slate-900 z-50 relative" style="${ssrRenderStyle(isSecondarySidebarVisible.value ? null : { display: "none" })}" data-v-c9e124b9>`);
        ssrRenderSlot(_ctx.$slots, "sidenav", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</aside><div class="flex flex-col w-full h-screen overflow-y-auto" data-v-c9e124b9><header class="w-full h-14 border-b text-xs text-gray-600 dark:text-slate-300 dark:border-slate-700" data-v-c9e124b9><div class="px-2 md:px-4 lg:px-8 h-full container mx-auto" data-v-c9e124b9><div class="flex justify-between items-center h-full space-x-2 border-l border-r" data-v-c9e124b9><div class="flex items-center" data-v-c9e124b9><button class="group inline-flex md:hidden p-2 text-slate-800 dark:text-slate-200 items-center justify-center rounded transition" data-v-c9e124b9><svg class="w-6 h-6 fill-current" viewBox="0 0 16 16" data-v-c9e124b9><rect class="origin-center" y="3" width="16" height="2" rx="1" data-v-c9e124b9></rect><rect class="origin-center" y="7" width="16" height="2" rx="1" data-v-c9e124b9></rect><rect class="origin-center" y="11" width="16" height="2" rx="1" data-v-c9e124b9></rect></svg></button><div class="p-2 ml-2" data-v-c9e124b9><h1 class="font-semibold text-gray-800 dark:text-slate-300 text-base" data-v-c9e124b9>${ssrInterpolate(title.value)}</h1>`);
      ...
      _push(`</div></div></header><main class="flex-grow" data-v-c9e124b9>`);
      _push(ssrRenderComponent(AlertMessage, null, null, _parent));
      _push(`<div class="px-2 md:px-4 lg:px-8 w-full h-full container mx-auto" data-v-c9e124b9><template><div class="border-l border-r h-full p-4" data-v-c9e124b9>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="mt-4" data-v-c9e124b9>`);
      _push(ssrRenderComponent(VarDump, { data: _ctx.$page }, null, _parent));
      _push(`</div></div></template></div></main><footer class="text-xs text-gray-600 dark:text-slate-400 border-t dark:border-slate-700" data-v-c9e124b9><div class="px-2 md:px-4 lg:px-8 container mx-auto" data-v-c9e124b9><p class="text-center md:text-end border-l border-r h-full p-4" data-v-c9e124b9> © ${ssrInterpolate(unref(currentYear))} ${ssrInterpolate(_ctx.$page.props.app.name)}. Version ${ssrInterpolate(_ctx.$page.props.app.version)}</p></div></footer></div></div></div><!--]-->`);
    };
  }
};
...
const AdminLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9e124b9"]]);
export {
  AdminLayout as A,
  _sfc_main$4 as _
};
