...
import { _ as _sfc_main$1 } from "./SettingsAdminLayout-DVsHzgD0.js";
...
import _sfc_main$4 from "./GeneralForm-D2gvA39T.js";
import DataForm from "./DataForm-CiiYJMcf.js";
import { u as useTranslatableForm } from "./useTranslatableForm-CskEpoto.js";
import "./AdminLayout-DoxjtInQ.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-col space-y-2"><section class="flex items-center justify-between pt-4"><h1 class="text-lg font-bold uppercase tracking-tight text-slate-700">${ssrInterpolate(_ctx.$t("New Payment Method"))}</h1>`);
      ...
      _push(ssrRenderComponent(unref(TabGroup), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(TabList), { class: "flex items-center w-full border-b border-gray-300 bg-white dark:bg-slate-900" }, {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(TabPanel), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="bg-white dark:bg-slate-900 border p-6"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("div", { class: "bg-white dark:bg-slate-900 border p-6" }, [
            ...
            return [
              createVNode(unref(TabList), { class: "flex items-center w-full border-b border-gray-300 bg-white dark:bg-slate-900" }, {
                default: withCtx(() => [
                  (openBlock(true), createBlock(Fragment, null, renderList(tabs.value, (tab) => {
                    return openBlock(), createBlock(unref(Tab), {
                      key: tab.key,
