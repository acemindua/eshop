import { ref, reactive, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, Transition, useSSRContext } from "vue";
...
import { _ as _sfc_main$1 } from "./CommerceAdminLayout-9oM-Stxp.js";
import { _ as _sfc_main$6 } from "./VarDump-0gz6Mom3.js";
import { TabGroup, TabList, Tab, TabPanels, TabPanel } from "@headlessui/vue";
import _sfc_main$5 from "./SEOForm-BvI4G_Kw.js";
import _sfc_main$4 from "./GeneralForm-DHX6vFD4.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    const handleSave = () => {
      router.post(route("admin.manufacturers.store"), form, {
        forceFormData: true,
        preserveState: true,
    ...
    return (_ctx, _push, _parent, _attrs) => {
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode(_sfc_main$4, {
                            ...
                            errors: __props.errors,
                            "is-editing": isEditing.value
                          }, null, 8, ["data", "form", "errors", "is-editing"])
                        ];
                      }
                    }),
                    _: 1
      ...
      if (_ctx.$page.props.app.mode === "local") {
        _push(`<section>`);
        _push(ssrRenderComponent(_sfc_main$6, { data: __props.data }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Manufacturers/Create.vue");
