...
import { Plugin, Superscript, ButtonView, Command, FindAndReplace, Undo, Heading, RemoveFormat, Bold, Italic, Underline, Strikethrough, Code, Subscript, Link, Table, TableToolbar, TableProperties, TableCellProperties, List, ListProperties, Image, ImageCaption, ImageResize, ImageStyle, ImageToolbar, ImageInsert, LinkImage, SimpleUploadAdapter, BlockQuote, Alignment, Indent, IndentBlock, SourceEditing, Fullscreen, Font, MediaEmbed, SpecialCharacters, SpecialCharactersEssentials, Emoji, Mention, ClassicEditor } from "ckeditor5";
...
const ckeditorConfig = {
  ...
  simpleUpload: {
    ...
    uploadUrl: typeof route !== "undefined" ? route("api.upload.image") : "/api/upload-image",
