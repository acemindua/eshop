...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col space-y-2 w-full" }, _attrs))} data-v-f03f5a2c><section class="flex items-center justify-between pt-4" data-v-f03f5a2c><span data-v-f03f5a2c></span>`);
      _push(ssrRenderComponent(_sfc_main$2, {
        buttons: actionButtons,
        loading: loading.value
      }, null, _parent));
      _push(`</section><section data-v-f03f5a2c>`);
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f03f5a2c"]]);
export {
  Create as default
};
