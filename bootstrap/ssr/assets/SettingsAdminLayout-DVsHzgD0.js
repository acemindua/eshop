import { ref, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, toDisplayString, resolveDynamicComponent, unref, openBlock, createBlock, useSSRContext } from "vue";
...
import { IconCreditCardFilled, IconCreditCard } from "@tabler/icons-vue";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconSettings = resolveComponent("IconSettings");
      const _component_IconLanguageHiragana = resolveComponent("IconLanguageHiragana");
      const _component_IconTruckDelivery = resolveComponent("IconTruckDelivery");
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_IconSettings, { stroke: "2" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_IconSettings, { stroke: "2" })
                  ];
                }
              }),
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_IconLanguageHiragana, { stroke: "2" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_IconLanguageHiragana, { stroke: "2" })
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_IconTruckDelivery, { stroke: "2" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_IconTruckDelivery, { stroke: "2" })
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(
                    _ctx.$page.url.startsWith("/pages") ? unref(IconCreditCardFilled) : unref(IconCreditCard)
                  ), {
                    stroke: "1",
                    class: "w-5 h-5"
