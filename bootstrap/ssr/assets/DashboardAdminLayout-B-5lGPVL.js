    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdminLayout, mergeProps({
        ...
        sidenav: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full h-14 border-b flex items-center p-4"${_scopeId}><h4 class="uppercase text-[12px] tracking-widest font-bold text-gray-500"${_scopeId}><span${_scopeId}>Dashboard</span></h4></div><ul class="flex flex-col w-full px-3 py-4"${_scopeId}>`);
            if (auth_user.value) {
              _push2(`<li class="mb-2"${_scopeId}><div class="m-4 flex flex-col gap-2 items-center justify-center text-xs"${_scopeId}><div class="relative flex items-center justify-center mb-2"${_scopeId}><img${ssrRenderAttr(
                "src",
              ...
              _push2(`</div></div><p class="font-semibold"${_scopeId}>${ssrInterpolate(auth_user.value.full_name)}</p><p class="flex items-center justify-center bg-brand rounded-full h-5 px-2 relative"${_scopeId}><span class="text-xs text-gray-50 -top-[2px] relative"${_scopeId}>${ssrInterpolate(auth_user.value.role)}</span></p><p class="text-gray-400 truncate w-full text-center"${_scopeId}>${ssrInterpolate(auth_user.value.email)}</p><div class="border-t border-dashed border-brand mt-2 w-[50%]"${_scopeId}></div></div></li>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<li${_scopeId}>`);
              ...
              createVNode("ul", { class: "flex flex-col w-full px-3 py-4" }, [
                auth_user.value ? (openBlock(), createBlock("li", {
                  ...
                  createVNode("div", { class: "m-4 flex flex-col gap-2 items-center justify-center text-xs" }, [
                    createVNode("div", { class: "relative flex items-center justify-center mb-2" }, [
                      createVNode("img", {
                    ...
                    createVNode("p", { class: "flex items-center justify-center bg-brand rounded-full h-5 px-2 relative" }, [
                    ...
                    createVNode("div", { class: "border-t border-dashed border-brand mt-2 w-[50%]" })
                  ])
