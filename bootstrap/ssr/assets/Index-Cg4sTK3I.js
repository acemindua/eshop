...
import { _ as _sfc_main$1 } from "./Layout-Co1-URQ2.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isEditing.value) {
        ...
        _push(`<p class="text-lg font-bold font-[&#39;Exo_2&#39;]" data-v-61cb2901>${ssrInterpolate(user.value.birthday ? unref(hooks)(user.value.birthday).format("DD.MM.YYYY") : "—")}</p>`);
      }
