...
import DataTable from "./DataTable-8X8pruKI.js";
import { _ as _sfc_main$4 } from "./VarDump-0gz6Mom3.js";
  ...
  setup(__props) {
    ...
    const deletePaymentMethod = (item) => {
      router.delete(route("admin.settings.payment-methods.destroy", item.id), {
        onBefore: () => confirm($t("Are you sure you want to delete this payment method?"))
      });
    };
    const handleCreate = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="md:flex items-center justify-between pt-4 gap-4 space-y-2">`);
      ...
      if (_ctx.$page.props.app.mode === "local") {
        _push(`<section>`);
        _push(ssrRenderComponent(_sfc_main$4, { data: __props.data }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Settings/PaymentMethods/Index.vue");
