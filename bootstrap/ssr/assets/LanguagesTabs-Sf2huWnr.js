...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col" }, _attrs))} data-v-a8aa735d>`);
      if (countLanguages.value > 1) {
        _push(`<div class="mb-3 overflow-x-auto no-scrollbar" data-v-a8aa735d><ul class="flex flex-nowrap gap-2 pb-1" data-v-a8aa735d><!--[-->`);
        ssrRenderList(locales.value, (locale, code) => {
          _push(`<li class="relative" data-v-a8aa735d><button type="button" class="${ssrRenderClass([[
          ...
          ], "px-3 py-2 rounded-lg border transition-all duration-200 inline-flex items-center gap-2 group"])}" data-v-a8aa735d>`);
          if (locale.regional) {
          ...
          _push(`<span class="font-bold text-[11px] uppercase tracking-wider md:hidden" data-v-a8aa735d>${ssrInterpolate(code)}</span><span class="capitalize text-[12px] hidden md:block font-medium opacity-80 group-hover:opacity-100 transition-opacity" data-v-a8aa735d>${ssrInterpolate(locale.native)}</span></button>`);
          if (hasError(code)) {
            _push(`<span class="absolute top-1 right-1 flex h-3 w-3 z-50" data-v-a8aa735d><span class="animate-ping absolute h-full w-full rounded-full bg-red-400 opacity-75" data-v-a8aa735d></span><span class="h-3 w-3 rounded-full bg-red-500 border-2 border-white shadow-sm" data-v-a8aa735d></span></span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
      ...
      _push(`<div class="transition-all duration-300 overflow-hidden" data-v-a8aa735d>`);
...
const LanguagesTabs = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8aa735d"]]);
export {
  LanguagesTabs as L
};
