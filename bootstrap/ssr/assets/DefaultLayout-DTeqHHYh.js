...
import { _ as _sfc_main$1 } from "./LangSwitcher-BIfY0gKc.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bg-white w-full min-h-screen flex flex-col justify-between"><div><header class="py-3 border-b border-gray-100"><div class="container mx-auto px-4"><div class="flex items-center justify-between">`);
      _push(ssrRenderComponent(unref(link_default), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(ApplicationLogo, { class: "w-10 h-10 bg-gray-600 fill-current transition-transform" }, null, _parent2, _scopeId));
            _push2(`<span class="text-lg font-bold uppercase text-gray-800"${_scopeId}>${ssrInterpolate(unref(page).props.app?.name)}</span>`);
          } else {
            return [
              createVNode(ApplicationLogo, { class: "w-10 h-10 bg-gray-600 fill-current transition-transform" }),
