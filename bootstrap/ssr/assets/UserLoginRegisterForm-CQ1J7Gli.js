  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (user.value) {
        _push(ssrRenderComponent(unref(link_default), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="hidden md:block text-sm font-semibold tracking-tight group-hover:underline"${_scopeId}>${ssrInterpolate(_ctx.$t("Кабінет"))}</span>`);
            } else {
              return [
                ...
                createVNode("span", { class: "hidden md:block text-sm font-semibold tracking-tight group-hover:underline" }, toDisplayString(_ctx.$t("Кабінет")), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<span class="hidden md:block text-sm font-semibold tracking-tight group-hover:underline">${ssrInterpolate(_ctx.$t("Login"))}</span></button>`);
      }
      _push(`</div>`);
