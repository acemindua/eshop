import { useSlots, computed, mergeProps, unref, withCtx, createVNode, renderSlot, Transition, openBlock, createBlock, createCommentVNode, useSSRContext, resolveDirective, resolveDynamicComponent, ref, watch, useModel, resolveComponent } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrGetDirectiveProps, ssrRenderVNode, ssrInterpolate, ssrRenderStyle } from "vue/server-renderer";
import { l as link_default, u as usePage } from "../ssr.js";
import { IconLayoutDashboardFilled, IconLayoutDashboard, IconShoppingCartFilled, IconShoppingCart, IconMessageCircle, IconSettings, IconX, IconChevronLeft, IconLogout } from "@tabler/icons-vue";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$3, mergeProps({
        href: _ctx.route("admin.dashboard"),
        active: _ctx.$page.component === "Admin/Dashboard" || _ctx.$page.url.startsWith("/users") || _ctx.$page.url.startsWith("/pages")
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(
              _ctx.$page.component === "Admin/Dashboard" || _ctx.$page.url.startsWith("/users") || _ctx.$page.url.startsWith("/pages") ? unref(IconLayoutDashboardFilled) : unref(IconLayoutDashboard)
            ), {
              stroke: 1,
              class: "w-6 h-6"
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isVisible.value && displayAlert.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          ...
          role: "alert"
        }, _attrs))} data-v-c5c8c2d7><div class="flex items-center" data-v-c5c8c2d7>`);
        if (displayAlert.value.type === "success") {
          _push(`<svg class="w-4 h-4 mr-2 fill-current text-green-500" viewBox="0 0 20 20" data-v-c5c8c2d7><path d="M0 11l2-2 5 5L18 3l2 2L7 18z" data-v-c5c8c2d7></path></svg>`);
        } else {
          _push(`<!---->`);
        }
        if (displayAlert.value.type === "error") {
          _push(`<svg class="w-4 h-4 mr-2 fill-current text-red-500" viewBox="0 0 20 20" data-v-c5c8c2d7><path d="M10 2a8 8 0 100 16 8 8 0 000-16zM8 9H6v2h2v-2zm3 0h-2v2h2v-2zm3 0h-2v2h2v-2zM4 10a6 6 0 1112 0 6 6 0 01-12 0z" data-v-c5c8c2d7></path></svg>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="font-bold" data-v-c5c8c2d7>${ssrInterpolate(displayAlert.value.type.charAt(0).toUpperCase() + displayAlert.value.type.slice(1))} ! </p><p class="ml-2" data-v-c5c8c2d7>${ssrInterpolate(displayAlert.value.message)}</p></div><button class="p-2 text-red-500" data-v-c5c8c2d7>`);
...
const AlertMessage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c5c8c2d7"]]);
const _sfc_main = {
  __name: "AdminLayout",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSidebarVisible.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-40 md:hidden transition-opacity duration-300" data-v-083a2765></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-slate-200 w-full min-h-screen" data-v-083a2765><div class="flex w-full h-full relative" data-v-083a2765><aside class="${ssrRenderClass([[
        isSidebarVisible.value ? "hidden md:flex relative" : "flex absolute h-full"
      ], "border-r dark:border-slate-800 dark:shadow-2xl"])}" data-v-083a2765><div class="bg-gray-50 dark:bg-slate-900 flex flex-col z-[60]" data-v-083a2765>`);
      _push(ssrRenderComponent(_sfc_main$2, null, null, _parent));
      _push(`</div><button class="bg-white dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 transition-all duration-150 absolute z-[60] top-11 -right-3 w-6 h-6 border dark:border-slate-600 rounded-full flex items-center justify-center" data-v-083a2765>`);
      ...
      if (_ctx.$slots.sidenav) {
        _push(`<div class="w-[200px] border-l dark:border-slate-800 bg-white dark:bg-slate-900 z-50 relative" style="${ssrRenderStyle(isSecondarySidebarVisible.value ? null : { display: "none" })}" data-v-083a2765>`);
        ssrRenderSlot(_ctx.$slots, "sidenav", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</aside><div class="flex flex-col w-full h-screen overflow-y-auto" data-v-083a2765><header class="w-full h-14 border-b text-xs text-gray-600 dark:text-slate-300 dark:border-slate-700" data-v-083a2765><div class="px-2 md:px-4 lg:px-8 h-full" data-v-083a2765><div class="flex justify-between items-center h-full space-x-2 border-l border-r" data-v-083a2765><div class="flex items-center" data-v-083a2765><button class="group inline-flex md:hidden p-2 text-slate-800 dark:text-slate-200 items-center justify-center rounded transition" data-v-083a2765><svg class="w-6 h-6 fill-current" viewBox="0 0 16 16" data-v-083a2765><rect class="origin-center" y="3" width="16" height="2" rx="1" data-v-083a2765></rect><rect class="origin-center" y="7" width="16" height="2" rx="1" data-v-083a2765></rect><rect class="origin-center" y="11" width="16" height="2" rx="1" data-v-083a2765></rect></svg></button><div class="p-2 ml-2" data-v-083a2765><h1 class="font-semibold text-gray-800 dark:text-slate-300 text-base" data-v-083a2765>${ssrInterpolate(title.value)}</h1>`);
      ...
      _push(`</div></div></header><main class="flex-grow" data-v-083a2765>`);
      _push(ssrRenderComponent(AlertMessage, null, null, _parent));
      _push(`<div class="px-2 md:px-4 lg:px-8 w-full h-full" data-v-083a2765><template><div class="border-l border-r h-full p-4" data-v-083a2765>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></template></div></main><footer class="text-xs text-gray-600 dark:text-slate-400 border-t dark:border-slate-700" data-v-083a2765><div class="px-2 md:px-4 lg:px-8" data-v-083a2765><p class="text-center md:text-end border-l border-r h-full p-4" data-v-083a2765> © ${ssrInterpolate(unref(currentYear))} ${ssrInterpolate(_ctx.$page.props.app.name)}. Version ${ssrInterpolate(_ctx.$page.props.app.version)}</p></div></footer></div></div></div><!--]-->`);
    };
  }
};
...
const AdminLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-083a2765"]]);
export {
  AdminLayout as A,
  _sfc_main$4 as _
};
