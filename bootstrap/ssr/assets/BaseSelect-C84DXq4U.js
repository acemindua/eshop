                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(ComboboxInput), {
                    class: ["w-full rounded-lg border py-2.5 text-sm shadow-sm transition-colors duration-200 outline-none focus:ring-4", [
                      ...
                      _ctx.error ? "border-red-500 focus:border-red-500 focus:ring-red-500/10 dark:border-red-500/80" : "border-slate-200 hover:border-slate-300 focus:border-indigo-500 focus:ring-indigo-500/10 dark:border-slate-700 dark:hover:border-slate-600 dark:focus:border-indigo-500",
