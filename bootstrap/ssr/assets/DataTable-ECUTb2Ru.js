...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</th><th class="p-2 w-24">#id</th></tr></thead><tbody>`);
      if (__props.items.length > 0) {
        ...
        _push(`<tr><td colspan="100%" class="p-4 text-center text-gray-500 border-t">${ssrInterpolate(_ctx.$t("No records found."))}</td></tr>`);
      }
      _push(`</tbody>`);
