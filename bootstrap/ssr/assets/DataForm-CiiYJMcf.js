...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:flex gap-6 w-full border rounded-none p-2 md:p-6 lg:p-12 bg-gray-50 dark:bg-slate-900/50 dark:border-slate-800" }, _attrs))} data-v-d9029a11><div class="w-full md:w-1/4 pb-4" data-v-d9029a11><div class="flex items-center space-x-2 mb-2 text-brand" data-v-d9029a11>`);
      _push(ssrRenderComponent(unref(IconSettings), { size: "20" }, null, _parent));
      _push(`<h2 class="uppercase font-bold tracking-tight text-sm" data-v-d9029a11>${ssrInterpolate(_ctx.$t("Technical Configuration"))}</h2></div><p class="py-2 text-xs text-gray-500 leading-relaxed" data-v-d9029a11>${ssrInterpolate(_ctx.$t(
        "Set up internal system codes, processing fees, and payment availability."
      ))}</p></div><div class="flex md:w-3/4 w-full flex-col space-y-6" data-v-d9029a11><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-d9029a11><div data-v-d9029a11>`);
      ...
      _push(`<p class="text-[10px] text-gray-400 mt-1 uppercase tracking-tighter" data-v-d9029a11>${ssrInterpolate(_ctx.$t(
      ...
      _push(`</div></div><hr class="border-gray-200 dark:border-slate-800" data-v-d9029a11><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-d9029a11><div data-v-d9029a11>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        for: "commission_percent",
        value: _ctx.$t("Commission Percent (%)"),
        class: "font-bold text-[10px] uppercase text-gray-400 mb-1"
      }, null, _parent));
      _push(`<div class="relative" data-v-d9029a11>`);
      _push(ssrRenderComponent(_sfc_main$2, {
      ...
      _push(`<span class="absolute right-3 top-2 text-gray-400 text-sm" data-v-d9029a11>%</span></div>`);
      _push(ssrRenderComponent(_sfc_main$3, {
        class: "mt-2",
      ...
      _push(`</div></div><hr class="border-gray-200 dark:border-slate-800" data-v-d9029a11><div class="bg-white dark:bg-slate-800 p-4 border border-dashed border-gray-200 dark:border-slate-700" data-v-d9029a11>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        for: "status-switcher",
        value: _ctx.$t("Method Status"),
        class: "font-bold text-[10px] uppercase text-gray-400 mb-3"
      }, null, _parent));
      _push(`<div class="flex items-center space-x-4" data-v-d9029a11>`);
      _push(ssrRenderComponent(_sfc_main$4, {
        modelValue: isActive.value,
        "onUpdate:modelValue": ($event) => isActive.value = $event,
        id: "status-switcher"
      }, null, _parent));
      _push(`<div class="flex flex-col" data-v-d9029a11><span class="${ssrRenderClass([
        "text-sm font-bold uppercase tracking-tight",
        isActive.value ? "text-green-600" : "text-red-500"
      ])}" data-v-d9029a11>${ssrInterpolate(isActive.value ? _ctx.$t("Active") : _ctx.$t("Disabled"))}</span><span class="text-[10px] text-gray-400 uppercase" data-v-d9029a11>${ssrInterpolate(isActive.value ? _ctx.$t(
...
const DataForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d9029a11"]]);
export {
  DataForm as default
};
