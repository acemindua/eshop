...
import "../ssr.js";
import { u as useTranslatableForm } from "./useTranslatableForm-D1vpFNTm.js";
import { TabGroup, TabList, Tab, TabPanels, TabPanel } from "@headlessui/vue";
import _sfc_main$3 from "./DataForm-DnRYnLtc.js";
import _sfc_main$2 from "./SeoForm-B5PcGkkf.js";
import _sfc_main$1 from "./GeneralForm-D1it5xdP.js";
import { _ as _sfc_main$4 } from "./StickyActions-DFSqE-gR.js";
import { _ as _sfc_main$5 } from "./ButtonTabGroup-DbwGHxsz.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleSave = () => {
      const url = props.isEditing ? route(`${props.routePrefix}.update`, props.data?.page?.id) : route(`${props.routePrefix}.store`);
      router.post(
        url,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        title: props.isEditing ? props.data?.page?.title ?? _ctx.$t("Page Details") : _ctx.$t("New Page"),
        description: props.isEditing ? _ctx.$t("Page details and settings management") : _ctx.$t(
          "Page creation form with all necessary details and settings"
        )
      }, {
                        ...
                        ssrRenderList(tabs, (tab) => {
                          _push4(ssrRenderComponent(unref(Tab), {
                            ...
                            default: withCtx(({ selected }, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_sfc_main$5, { selected }, {
                                ...
                                return [
                                  createVNode(_sfc_main$5, { selected }, {
                                    default: withCtx(() => [
                                      createVNode("div", { class: "flex items-center gap-2" }, [
                                        createTextVNode(toDisplayString(_ctx.$t(tab.label)) + " ", 1),
                                        hasTabErrors(tab) ? (openBlock(), createBlock("span", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Core/Pages/Components/PageForm.vue");
