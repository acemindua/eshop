...
import _sfc_main$5 from "./DataForm-B_akD84S.js";
import _sfc_main$4 from "./SEOForm-C6GVUx_h.js";
import _sfc_main$3 from "./GeneralForm-3fSy3KDg.js";
import "../ssr.js";
import _sfc_main$6 from "./MediaForm-Qqh1aNzJ.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isScrolled.value) {
        _push(`<div class="fixed bottom-6 right-[50%] md:rigth-[50%]">`);
        _push(ssrRenderComponent(ButtonsGroup, { buttons: actionButtons }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
