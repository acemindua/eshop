...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><fieldset class="pt-4 border-t"><legend class="text-sm font-medium text-gray-700 mb-2">${ssrInterpolate(_ctx.$t("Brands"))}</legend><div class="space-y-2"><!--[-->`);
      ssrRenderList(__props.brands, (brand) => {
        _push(`<label class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_sfc_main$1, {
          value: brand.id,
