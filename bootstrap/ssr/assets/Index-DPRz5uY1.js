...
import { IconCategory, IconSortAscending, IconSortDescending, IconArrowsSort } from "@tabler/icons-vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><h1 class="text-base font-semibold tracking-tight dark:text-slate-200">${ssrInterpolate(_ctx.$t("Categories"))}</h1><p class="text-xs text-slate-400 font-medium">${ssrInterpolate(_ctx.$t("Manage category content and structure"))}</p></div></div>`);
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        headers: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></th><th class="p-2 text-center w-48"${_scopeId}>${ssrInterpolate(_ctx.$t("Parent"))}</th><th class="p-2 text-center w-48"${_scopeId}>${ssrInterpolate(_ctx.$t("Status"))}</th>`);
          } else {
            return [
              ...
              createVNode("th", { class: "p-2 text-center w-48" }, toDisplayString(_ctx.$t("Parent")), 1),
        ...
        "item-data": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</td><td class="p-2"${_scopeId}><p${_scopeId}>${ssrInterpolate(item.title)}</p><p class="text-xs text-gray-500 hover:text-indigo-400 duration-150 transition"${_scopeId}> url: ${ssrInterpolate(`/${item.slug}`)}</p></td><td class="p-2"${_scopeId}>${ssrInterpolate(item.parent ? item.parent.title : "")}</td><td class="p-2"${_scopeId}><div class="flex justify-center"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("td", { class: "p-2" }, toDisplayString(item.parent ? item.parent.title : ""), 1),
              createVNode("td", { class: "p-2" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Commerce/Categories/Index.vue");
