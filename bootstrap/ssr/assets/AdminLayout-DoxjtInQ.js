import { computed, unref, mergeProps, withCtx, createVNode, renderSlot, Transition, openBlock, createBlock, createCommentVNode, useSSRContext, resolveDirective, ref, watch, useModel } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttrs, ssrGetDirectiveProps, ssrInterpolate, ssrRenderAttr, ssrRenderStyle } from "vue/server-renderer";
import { Link, usePage } from "@inertiajs/vue3";
import { IconLayoutDashboard, IconShoppingBag, IconMessageCircle, IconSettings, IconX, IconChevronLeft } from "@tabler/icons-vue";
...
const baseClasses = "inline-flex space-x-2 w-full items-center p-2 rounded-lg text-sm leading-5 transition duration-150 ease-in-out hover:bg-slate-100 dark:hover:bg-slate-800";
const activeClasses = "";
const _sfc_main$5 = {
  __name: "AdminNavLink",
  ...
  props: {
    ...
    // Новий пропс для керування видимістю тексту
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Link), mergeProps({
        href: __props.href,
        class: classes.value,
        title: !__props.showText ? _ctx.$slots.default()[0].children : ""
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([[__props.active ? "text-brand" : "", __props.iconClass], "flex items-center justify-center shrink-0 transition duration-150 ease-in-out"])}"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "icon", {}, null, _push2, _parent2, _scopeId);
            _push2(`</span>`);
            if (__props.showText) {
              _push2(`<span class="${ssrRenderClass([__props.textClass, "flex items-center whitespace-nowrap overflow-hidden"])}"${_scopeId}>`);
            ...
            return [
              createVNode("span", {
                class: ["flex items-center justify-center shrink-0 transition duration-150 ease-in-out", [__props.active ? "text-brand" : "", __props.iconClass]]
              }, [
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  __props.showText ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: ["flex items-center whitespace-nowrap overflow-hidden", __props.textClass]
                  }, [
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$6, { class: "w-full h-full bg-brand" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$6, { class: "w-full h-full bg-brand" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$4, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(IconLayoutDashboard), {
              stroke: 1,
              class: "w-6 h-6"
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(unref(IconLayoutDashboard), {
                stroke: 1,
                class: "w-6 h-6"
              })
            ];
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSidebarVisible.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-40 md:hidden transition-opacity duration-300" data-v-8a553b63></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-slate-200 w-full min-h-screen" data-v-8a553b63><div class="flex w-full h-full relative" data-v-8a553b63><aside class="${ssrRenderClass([[
        isSidebarVisible.value ? "hidden md:flex relative" : "flex absolute h-full"
      ], "border-r dark:border-slate-800 dark:shadow-2xl"])}" data-v-8a553b63><div class="bg-gray-50 dark:bg-slate-900 flex flex-col z-[60]" data-v-8a553b63>`);
      _push(ssrRenderComponent(_sfc_main$3, null, null, _parent));
      _push(`</div><button class="bg-white dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 transition-all duration-150 absolute z-[60] top-11 -right-3 w-6 h-6 border dark:border-slate-600 rounded-full flex items-center justify-center" data-v-8a553b63>`);
      ...
      if (_ctx.$slots.sidenav) {
        _push(`<div class="w-60 border-l dark:border-slate-800 bg-white dark:bg-slate-900 z-50 relative" style="${ssrRenderStyle(isSecondarySidebarVisible.value ? null : { display: "none" })}" data-v-8a553b63>`);
        ssrRenderSlot(_ctx.$slots, "sidenav", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</aside><div class="flex flex-col w-full h-screen overflow-y-auto" data-v-8a553b63><header class="w-full h-14 border-b text-xs text-gray-600 dark:text-slate-300 dark:border-slate-700" data-v-8a553b63><div class="px-2 md:px-4 lg:px-8 h-full" data-v-8a553b63><div class="flex justify-between items-center h-full space-x-2 border-l border-r" data-v-8a553b63><div class="flex items-center" data-v-8a553b63><button class="group inline-flex md:hidden p-2 text-slate-800 dark:text-slate-200 items-center justify-center rounded transition" data-v-8a553b63><svg class="w-6 h-6 fill-current" viewBox="0 0 16 16" data-v-8a553b63><rect class="origin-center" y="3" width="16" height="2" rx="1" data-v-8a553b63></rect><rect class="origin-center" y="7" width="16" height="2" rx="1" data-v-8a553b63></rect><rect class="origin-center" y="11" width="16" height="2" rx="1" data-v-8a553b63></rect></svg></button><div class="p-2 ml-2" data-v-8a553b63><h1 class="font-semibold text-gray-800 dark:text-slate-300 text-base" data-v-8a553b63>${ssrInterpolate(title.value)}</h1>`);
      _push(ssrRenderComponent(_sfc_main$8, null, null, _parent));
      _push(`</div></div>`);
      _push(ssrRenderComponent(_sfc_main$2, {
        data: _ctx.$page.props.auth.user
      }, null, _parent));
      _push(`</div></div></header><main class="flex-grow" data-v-8a553b63>`);
      _push(ssrRenderComponent(AlertMessage, null, null, _parent));
      _push(`<div class="px-2 md:px-4 lg:px-8 w-full h-full" data-v-8a553b63><template><div class="border-l border-r h-full p-4" data-v-8a553b63>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></template></div></main><footer class="text-xs text-gray-600 dark:text-slate-400 border-t dark:border-slate-700" data-v-8a553b63><div class="px-2 md:px-4 lg:px-8" data-v-8a553b63><p class="text-center md:text-end border-l border-r h-full p-4" data-v-8a553b63> © ${ssrInterpolate(unref(currentYear))} ${ssrInterpolate(_ctx.$page.props.app.name)}. Version ${ssrInterpolate(_ctx.$page.props.app.version)}</p></div></footer></div></div></div><!--]-->`);
    };
  }
};
...
const AdminLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a553b63"]]);
export {
  AdminLayout as A,
  _sfc_main$5 as _
};
