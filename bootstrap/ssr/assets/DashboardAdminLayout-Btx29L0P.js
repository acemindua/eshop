import { ref, computed, mergeProps, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, resolveDynamicComponent, unref, openBlock, createBlock, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderVNode } from "vue/server-renderer";
import { A as AdminLayout, _ as _sfc_main$1 } from "./AdminLayout-DonT5IOt.js";
import { IconUserFilled, IconUser, IconClipboardFilled, IconClipboard, IconManualGearboxFilled, IconManualGearbox } from "@tabler/icons-vue";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              icon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(
                    _ctx.$page.url.startsWith("/menus") ? unref(IconManualGearboxFilled) : unref(IconManualGearbox)
                  ), {
                    stroke: "1",
                    class: "w-5 h-5"
                  }, null), _parent3, _scopeId2);
