...
import { _ as _sfc_main$1 } from "./SettingsAdminLayout-DudLXlto.js";
...
import "./AdminLayout-Cvyy3vL0.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col space-y-4" }, _attrs))} data-v-2ce129a5><section class="flex flex-wrap items-center justify-between gap-4" data-v-2ce129a5><div class="flex flex-wrap items-center gap-3" data-v-2ce129a5>`);
      ...
      _push(`<div class="inline-flex rounded-lg border border-slate-200 p-0.5 bg-white select-none" data-v-2ce129a5><button type="button" class="${ssrRenderClass([
      ...
      _push(`<span data-v-2ce129a5>Всі</span></button><button type="button" class="${ssrRenderClass([
      ...
      _push(`<span data-v-2ce129a5>Порожні</span></button></div><div class="flex items-center gap-1 border-l border-slate-200 pl-3 select-none" data-v-2ce129a5><!--[-->`);
      ssrRenderList(locales.value, (locale, code) => {
        ...
        ], "px-2.5 py-1.5 rounded-lg text-xs font-bold transition-all inline-flex items-center gap-2 border"])}" data-v-2ce129a5>`);
        if (locale.regional) {
        ...
        _push(`<span class="uppercase tracking-wider text-[11px]" data-v-2ce129a5>${ssrInterpolate(code)}</span>`);
        if (emptyCounts.value[code] > 0) {
          ...
          ])}" data-v-2ce129a5>${ssrInterpolate(emptyCounts.value[code])}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
      ...
      _push(`</section><section class="space-y-6 overflow-y-auto max-h-[70vh] pr-1 scrollbar-thin" data-v-2ce129a5><!--[-->`);
      ssrRenderList(groupedItems.value, (groupItems, groupName) => {
        _push(`<div class="space-y-3" data-v-2ce129a5><div class="flex items-center gap-2 px-1 pt-2" data-v-2ce129a5><div class="p-1 rounded bg-slate-100 text-slate-600 border border-slate-200/60" data-v-2ce129a5>`);
        _push(ssrRenderComponent(unref(IconFolder), { size: "14" }, null, _parent));
        _push(`</div><span class="text-xs font-bold uppercase tracking-widest text-slate-400" data-v-2ce129a5>${ssrInterpolate(groupName)}</span><div class="h-px bg-gradient-to-r from-slate-200 to-transparent flex-1 ml-2" data-v-2ce129a5></div></div><div class="grid grid-cols-1 xl:grid-cols-2 gap-3" data-v-2ce129a5><!--[-->`);
        ssrRenderList(groupItems, (item) => {
          ...
          ], "bg-white border rounded-xl p-3 flex flex-col justify-between transition-all duration-150 group/card relative focus-within:ring-2 focus-within:ring-slate-900/10 focus-within:border-slate-400"])}" data-v-2ce129a5><div class="flex items-start justify-between gap-4 mb-2" data-v-2ce129a5><div class="cursor-pointer max-w-[85%] font-mono text-[11px] text-slate-600 bg-slate-50 border border-slate-200 px-2 py-1 rounded-md hover:bg-slate-100 hover:text-slate-900 transition-all flex items-center gap-1.5 select-none" data-v-2ce129a5><span class="truncate" data-v-2ce129a5>${ssrInterpolate(item.key)}</span>`);
          ...
          _push(`</div><div class="flex items-center gap-1 mt-1" data-v-2ce129a5><!--[-->`);
          ssrRenderList(localesKeys.value, (lKey) => {
            _push(`<span class="${ssrRenderClass([
              isFieldEmpty(item, lKey) ? "bg-slate-200" : "bg-green-500",
              "w-3 h-1.5 rounded-sm transition-all"
            ])}"${ssrRenderAttr("title", `Мова: ${lKey.toUpperCase()} — ${isFieldEmpty(item, lKey) ? "Пусто" : "Заповнено"}`)} data-v-2ce129a5></span>`);
          });
          _push(`<!--]--></div></div><div class="relative w-full mt-1 flex items-center" data-v-2ce129a5><textarea rows="1" class="translation-textarea w-full border border-slate-200 rounded-lg pl-3 pr-14 py-2 text-sm font-medium bg-slate-50/30 text-slate-800 placeholder-slate-400 focus:bg-white focus:border-slate-400 focus:ring-0 block resize-none transition-all duration-75"${ssrRenderAttr("placeholder", `Текст для [${globalLocale.value}]...`)} data-v-2ce129a5>${ssrInterpolate(item.values[globalLocale.value])}</textarea><div class="absolute right-2.5 flex items-center space-x-1.5 select-none" data-v-2ce129a5>`);
          if (item.values[globalLocale.value]) {
            _push(`<button type="button" class="p-1 rounded text-slate-400 hover:bg-slate-100 hover:text-slate-600 opacity-0 group-hover/card:opacity-100 focus:opacity-100 transition-opacity" title="Очистити" data-v-2ce129a5>`);
            _push(ssrRenderComponent(unref(IconX), { size: "12" }, null, _parent));
            _push(`</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-100 text-slate-400 border border-slate-200" data-v-2ce129a5>${ssrInterpolate(globalLocale.value)}</span></div></div></div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]-->`);
      if (filteredItems.value.length === 0) {
        _push(`<div class="bg-white border border-slate-200 rounded-2xl p-12 text-center text-slate-400 text-sm flex flex-col items-center justify-center gap-1.5 shadow-sm" data-v-2ce129a5>`);
        _push(ssrRenderComponent(unref(IconAlertTriangle), {
          class: "text-slate-300",
          size: "24"
        }, null, _parent));
        _push(`<span class="font-semibold text-slate-700" data-v-2ce129a5>Перекладів не знайдено</span><p class="text-xs text-slate-400" data-v-2ce129a5> Змініть параметри пошуку або перевірте іншу мову. </p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Settings/Options.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Options = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ce129a5"]]);
export {
  Options as default
};
