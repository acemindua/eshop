...
import { ssrRenderAttrs, ssrLooseEqual, ssrGetDynamicModelProps, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import Slider from "@vueform/slider";
import { _ as _sfc_main$2 } from "./InputLabel-BSWPuOQO.js";
import { _ as _sfc_main$4 } from "./TextInput-5OXx1Hvj.js";
/* empty css                 */
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(props.brands, (brand) => {
        _push(`<label${ssrRenderAttr("value", _ctx.$t("Brand"))} class="text-sm mb-2 text-gray-800 flex items-center gap-2">`);
        _push(ssrRenderComponent(_sfc_main$3, {
          value: brand.id,
