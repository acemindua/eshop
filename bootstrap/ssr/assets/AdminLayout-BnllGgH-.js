...
import { l as link_default, c as usePage, h as head_default } from "../ssr.js";
import { _ as _sfc_main$6 } from "./Breadcrumbs-BaC6CclY.js";
import { IconCheck, IconAlertCircle, IconInfoCircle, IconX, IconLayoutDashboardFilled, IconLayoutDashboard, IconSettingsFilled, IconSettings, IconChevronLeft, IconLogout } from "@tabler/icons-vue";
import { defineStore } from "pinia";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as _sfc_main$5 } from "./ApplicationLogo-ClfPV3Yy.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(link_default), mergeProps({
        ...
        class: [
          ...
          __props.active ? "text-brand bg-slate-900/50 dark:bg-slate-800 shadow-inner" : "text-gray-100 dark:text-slate-400 hover:bg-slate-900 dark:hover:bg-slate-800/50"
        ]
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(link_default), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$5, { class: "w-full h-full" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$5, { class: "w-full h-full" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({
        href: _ctx.route("admin.dashboard"),
        active: _ctx.$page.component === "Admin/Dashboard" || _ctx.$page.url.startsWith("/users") || _ctx.$page.url.startsWith("/pages") || _ctx.$page.url.startsWith("/menus")
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(
              _ctx.$page.component === "Admin/Dashboard" || _ctx.$page.url.startsWith("/users") || _ctx.$page.url.startsWith("/pages") || _ctx.$page.url.startsWith("/menus") ? unref(IconLayoutDashboardFilled) : unref(IconLayoutDashboard)
            ), {
              stroke: 1,
              class: "w-6 h-6"
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSidebarVisible.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-40 md:hidden transition-opacity duration-300" data-v-ec8045bb></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-slate-200 w-full min-h-screen" data-v-ec8045bb><div class="flex w-full h-full relative" data-v-ec8045bb><aside class="${ssrRenderClass([[
        isSidebarVisible.value ? "hidden md:flex relative" : "flex absolute h-full"
      ], "border-r dark:border-slate-800 dark:shadow-2xl"])}" data-v-ec8045bb><div class="bg-slate-800 flex flex-col z-[60]" data-v-ec8045bb>`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(`</div><button class="${ssrRenderClass([
        isSecondarySidebarVisible.value ? "bg-white dark:bg-slate-700 hover:bg-brand hover:text-white dark:hover:bg-slate-600 " : "bg-slate-700 hover:bg-brand text-white hover:bg-brand-dark ",
        "transition-all duration-150 absolute z-[60] top-11 -right-3 w-6 h-6 border dark:border-slate-600 rounded-full flex items-center justify-center"
      ])}" data-v-ec8045bb>`);
      ...
      if (_ctx.$slots.sidenav) {
        _push(`<div class="w-[200px] border-l dark:border-slate-800 bg-white dark:bg-slate-900 z-50 relative" style="${ssrRenderStyle(isSecondarySidebarVisible.value ? null : { display: "none" })}" data-v-ec8045bb>`);
        ssrRenderSlot(_ctx.$slots, "sidenav", {}, null, _push, _parent);
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</aside><div class="flex flex-col w-full h-screen overflow-y-auto" data-v-ec8045bb><header class="w-full h-14 border-b text-xs text-gray-600 dark:text-slate-300 dark:border-slate-700" data-v-ec8045bb><div class="px-2 md:px-4 lg:px-8 h-full container mx-auto" data-v-ec8045bb><div class="flex justify-between items-center h-full space-x-2 border-l border-r" data-v-ec8045bb><div class="flex items-center" data-v-ec8045bb><button class="group inline-flex md:hidden p-2 text-slate-800 dark:text-slate-200 items-center justify-center rounded transition" data-v-ec8045bb><svg class="w-6 h-6 fill-current" viewBox="0 0 16 16" data-v-ec8045bb><rect class="origin-center" y="3" width="16" height="2" rx="1" data-v-ec8045bb></rect><rect class="origin-center" y="7" width="16" height="2" rx="1" data-v-ec8045bb></rect><rect class="origin-center" y="11" width="16" height="2" rx="1" data-v-ec8045bb></rect></svg></button><div class="p-2 ml-2" data-v-ec8045bb><h1 class="font-semibold text-gray-800 dark:text-slate-300 text-base" data-v-ec8045bb>${ssrInterpolate(title.value)}</h1>`);
      ...
      _push(`</div></div></header><main class="flex-grow" data-v-ec8045bb>`);
      _push(ssrRenderComponent(AlertMessage, null, null, _parent));
      _push(`<div class="px-2 md:px-4 lg:px-8 w-full h-full container mx-auto" data-v-ec8045bb><template><div class="border-l border-r h-full p-4" data-v-ec8045bb>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="mt-4" data-v-ec8045bb>`);
      _push(ssrRenderComponent(VarDump, { data: _ctx.$page }, null, _parent));
      _push(`</div></div></template></div></main><footer class="text-xs text-gray-600 dark:text-slate-400 border-t dark:border-slate-700" data-v-ec8045bb><div class="px-2 md:px-4 lg:px-8 container mx-auto" data-v-ec8045bb><p class="text-center md:text-end border-l border-r h-full p-4" data-v-ec8045bb> © ${ssrInterpolate(unref(currentYear))} ${ssrInterpolate(_ctx.$page.props.app.name)}. Version ${ssrInterpolate(_ctx.$page.props.app.version)}</p></div></footer></div></div></div><!--]-->`);
    };
  }
};
...
const AdminLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec8045bb"]]);
export {
  AdminLayout as A,
  _sfc_main$4 as _
};
