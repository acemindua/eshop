    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.items.length > 0) {
        ...
        ssrRenderList(__props.items, (item, key) => {
          ...
          _push(`</td><td class="p-2 text-center text-gray-500">${ssrInterpolate(_ctx.$formatSerial(count.value + key))}</td><th class="p-1"><div class="relative flex items-center justify-center w-12 h-12 mx-auto">`);
