...
import { getOverflowAncestors, offset, autoPlacement, shift, flip, arrow, size, computePosition } from "@floating-ui/dom";
const Sale$5 = "Verkauf";
const Products$5 = ":count Produkt|:count Produkte";
const reviews$5 = ":count Bewertung|:count Bewertungen|:count Bewertungen";
...
const Products$4 = ":count product|:count products";
...
const reviews$4 = ":count review|:count reviews|:count reviews";
const stars$1 = "stars";
const tasks$2 = "tasks";
const to$4 = "to";
const en = {
  ...
  "Brand details and settings management": "Brand details and settings management",
  Brands: Brands$2,
  Browse: Browse$4,
  Buy: Buy$2,
  Cancel: Cancel$4,
  ...
  "Category details and settings management": "Category details and settings management",
  Checkout: Checkout$2,
  Choose: Choose$4,
...
into your web browser:`,
  ...
  "In progress": "In progress",
  "Initialize Target Version": "Initialize Target Version",
  ...
  "Item details and settings management": "Item details and settings management",
  Items: Items$2,
  Language: Language$2,
  "Last Name": "Last Name",
  "Last name": "Last name",
  ...
  "Manage brand content and structure": "Manage brand content and structure",
  "Manage category content and structure": "Manage category content and structure",
  ...
  "Manage item content and structure": "Manage item content and structure",
  "Manage menu content and structure": "Manage menu content and structure",
  "Manage operational and personal parameters": "Manage operational and personal parameters",
  "Manage page content and structure": "Manage page content and structure",
  "Manage user accounts, roles, and permissions": "Manage user accounts, roles, and permissions",
  "Manage warehous content and structure": "Manage warehous content and structure",
  ...
  "Modify Version Attributes": "Modify Version Attributes",
  "Move to another version": "Move to another version",
  "Moved Permanently": "Moved Permanently",
  "Multi-Status": "Multi-Status",
  "Multiple Choices": "Multiple Choices",
  Name: Name$4,
  "Navigations & Menus": "Navigations & Menus",
  ...
  "No popular products found.": "No popular products found.",
  "No products found": "No products found",
  "No records found.": "No records found.",
  "No records under this pipeline.": "No records under this pipeline.",
  ...
  "No versions created yet.": "No versions created yet.",
  ...
  "Only registered users can leave reviews.": "Only registered users can leave reviews.",
  Open: Open$4,
  ...
  "Page details and settings management": "Page details and settings management",
  Pages: Pages$2,
  ...
  "Regards,": "Regards,",
  Register: Register$4,
  "Register a secure user into the ecosystem": "Register a secure user into the ecosystem",
  "Release / Roadmap Progress": "Release / Roadmap Progress",
  "Released on": "Released on",
  "Relocate Task": "Relocate Task",
  ...
  "Short scope summary": "Short scope summary",
  Show: Show$4,
  "Show :name": "Show :name",
  "Show All": "Show All",
  Showing: Showing$4,
  ...
  "System Group Assignment": "System Group Assignment",
  Tag: Tag$4,
  Tags: Tags$4,
  Target: Target$2,
  "Target Milestone / Release": "Target Milestone / Release",
  ...
  "Warehouse details and settings management": "Warehouse details and settings management",
  "Warehouse/Address": "Warehouse/Address",
  Warehouses: Warehouses$2,
  "Web Server is Down": "Web Server is Down",
  "What was implemented or fixed?": "What was implemented or fixed?",
  "Whoops!": "Whoops!",
...
const Sale$3 = "Venta";
const Products$3 = ":count producto|:count productos";
const reviews$3 = ":count reseña|:count reseñas|:count reseñas";
...
const Products$2 = ":count produkt|:count produkty|:count produktów";
...
const reviews$2 = ":count opinia|:count opinie|:count opinii";
const tasks$1 = "tasks";
const to$2 = "do";
const pl = {
  "Highest Rated": "Highest Rated",
...
const Sale$1 = "Распродажа";
const Products$1 = ":count товар|:count товара|:count товаров";
const reviews$1 = ":count отзыв|:count отзыва|:count отзывов";
...
const Products = ":count товар|:count товари|:count товарів";
...
const reviews = ":count відгук|:count відгуки|:count відгуків";
const stars = "stars";
const tasks = "tasks";
const to = "до";
const uk = {
  "Highest Rated": "За рейтингом",
  "#ID": "#ID",
...
async function createInertiaApp({
  ...
  const resolveComponent2 = (name2) => Promise.resolve(resolve(name2)).then((module) => module.default || module);
  let head = [];
...
function extractFromString(part, number) {
  ...
  if (condition.includes(",")) {
    let [from, to2] = condition.split(",");
    if (to2 === "*" && number >= parseFloat(from)) {
      return value;
    } else if (from === "*" && number <= parseFloat(to2)) {
      return value;
    } else if (number >= parseFloat(from) && number <= parseFloat(to2)) {
      return value;
    }
  }
...
function wTransChoice(key2, number, replacements = {}) {
  return I18n.getSharedInstance().wTransChoice(key2, number, replacements);
}
const i18nVue = {
  install(app, options = {}) {
...
const helper = {
  install(app) {
    const numberFormatter = (options = {}) => new Intl.NumberFormat("uk-UA", options);
    ...
    app.config.globalProperties.$formatDate = (date, options = {}) => {
      ...
      if (typeof date === "string" && /^\d{2}\.\d{2}\.\d{4}$/.test(date)) {
        ...
        d2 = /* @__PURE__ */ new Date(`${year}-${month}-${day}`);
      } else {
        d2 = new Date(date);
      }
      if (isNaN(d2.getTime())) {
...
createServer(
  (page2) => createInertiaApp({
    ...
    resolve: (name2) => resolvePageComponent(
      `./Pages/${name2}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Admin/Commerce/Brands/Components/BrandForm.vue": () => import("./assets/BrandForm-Cs_ibdfi.js"), "./Pages/Admin/Commerce/Brands/Create.vue": () => import("./assets/Create-tHiuIMOu.js"), "./Pages/Admin/Commerce/Brands/Edit.vue": () => import("./assets/Edit-WSjqzd1c.js"), "./Pages/Admin/Commerce/Brands/Index.vue": () => import("./assets/Index-C3qsbMBX.js"), "./Pages/Admin/Commerce/Brands/Partials/DataForm.vue": () => import("./assets/DataForm-YAJ8z_Ra.js"), "./Pages/Admin/Commerce/Brands/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-Vv766DyR.js"), "./Pages/Admin/Commerce/Brands/Partials/MediaForm.vue": () => import("./assets/MediaForm-CHxeVoAB.js"), "./Pages/Admin/Commerce/Brands/Partials/SEOForm.vue": () => import("./assets/SEOForm-Dk-pZEdT.js"), "./Pages/Admin/Commerce/Brands/Show.vue": () => import("./assets/Show-CmgppEJp.js"), "./Pages/Admin/Commerce/Categories/Components/CategoryForm.vue": () => import("./assets/CategoryForm-D2tWAOdd.js"), "./Pages/Admin/Commerce/Categories/Create.vue": () => import("./assets/Create-C6KF_6Py.js"), "./Pages/Admin/Commerce/Categories/Edit.vue": () => import("./assets/Edit-CVbJ-tRo.js"), "./Pages/Admin/Commerce/Categories/Index.vue": () => import("./assets/Index-BnIJDbJD.js"), "./Pages/Admin/Commerce/Categories/Partials/DataForm.vue": () => import("./assets/DataForm--yk2mLmj.js"), "./Pages/Admin/Commerce/Categories/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-BnFd_8WA.js"), "./Pages/Admin/Commerce/Categories/Partials/MediaForm.vue": () => import("./assets/MediaForm-BVo6Fddm.js"), "./Pages/Admin/Commerce/Categories/Partials/SEOForm.vue": () => import("./assets/SEOForm-DidQluF0.js"), "./Pages/Admin/Commerce/Categories/Show.vue": () => import("./assets/Show-Up2BFxm2.js"), "./Pages/Admin/Commerce/Items/Components/ItemForm.vue": () => import("./assets/ItemForm-CjIn1r6-.js"), "./Pages/Admin/Commerce/Items/Create.vue": () => import("./assets/Create-C1oQgmMu.js"), "./Pages/Admin/Commerce/Items/Edit.vue": () => import("./assets/Edit-B95Vh4oS.js"), "./Pages/Admin/Commerce/Items/Index.vue": () => import("./assets/Index-DRZSlbKK.js"), "./Pages/Admin/Commerce/Items/Partials/DataForm.vue": () => import("./assets/DataForm-DhJ3m80V.js"), "./Pages/Admin/Commerce/Items/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-CqIgc_Ae.js"), "./Pages/Admin/Commerce/Items/Partials/MediaForm.vue": () => import("./assets/MediaForm-B6SY_Zjz.js"), "./Pages/Admin/Commerce/Items/Partials/SEOForm.vue": () => import("./assets/SEOForm-Bzf3Dqm7.js"), "./Pages/Admin/Commerce/Items/Show.vue": () => import("./assets/Show-CAyvktdZ.js"), "./Pages/Admin/Commerce/Orders/Create.vue": () => import("./assets/Create-CVK9JkJ1.js"), "./Pages/Admin/Commerce/Orders/Edit.vue": () => import("./assets/Edit-ByHXykiV.js"), "./Pages/Admin/Commerce/Orders/Index.vue": () => import("./assets/Index-D25BPpo_.js"), "./Pages/Admin/Commerce/Orders/Partials/DataForm.vue": () => import("./assets/DataForm-CHnfIpJK.js"), "./Pages/Admin/Commerce/Orders/Partials/DataTable.vue": () => import("./assets/DataTable-CnUNAvfK.js"), "./Pages/Admin/Commerce/Orders/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-CXBHik4-.js"), "./Pages/Admin/Commerce/Settings/Warehouses/Components/WarehouseForm.vue": () => import("./assets/WarehouseForm-CREytOPY.js"), "./Pages/Admin/Commerce/Settings/Warehouses/Create.vue": () => import("./assets/Create-ButZzZSs.js"), "./Pages/Admin/Commerce/Settings/Warehouses/Edit.vue": () => import("./assets/Edit-BZCsZZQ_.js"), "./Pages/Admin/Commerce/Settings/Warehouses/Index.vue": () => import("./assets/Index-CBjZ9xun.js"), "./Pages/Admin/Commerce/Settings/Warehouses/Show.vue": () => import("./assets/Show-FLzB41pP.js"), "./Pages/Admin/Core/Menus/Components/MenuForm.vue": () => import("./assets/MenuForm-DpvWAzuV.js"), "./Pages/Admin/Core/Menus/Components/NestedMenuItems.vue": () => import("./assets/NestedMenuItems-z9BD8oLh.js"), "./Pages/Admin/Core/Menus/Create.vue": () => import("./assets/Create-DxeNdt-9.js"), "./Pages/Admin/Core/Menus/Edit.vue": () => import("./assets/Edit-BDwZgby6.js"), "./Pages/Admin/Core/Menus/Index.vue": () => import("./assets/Index-BxNLW4Bh.js"), "./Pages/Admin/Core/Pages/Components/PageForm.vue": () => import("./assets/PageForm-wy8Naf7D.js"), "./Pages/Admin/Core/Pages/Create.vue": () => import("./assets/Create-ChEa1GSA.js"), "./Pages/Admin/Core/Pages/Edit.vue": () => import("./assets/Edit-CiOhsT4g.js"), "./Pages/Admin/Core/Pages/Index.vue": () => import("./assets/Index-CWpWirwk.js"), "./Pages/Admin/Core/Pages/Partials/DataForm.vue": () => import("./assets/DataForm-gtGf74ma.js"), "./Pages/Admin/Core/Pages/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-DCef4e4-.js"), "./Pages/Admin/Core/Pages/Partials/SeoForm.vue": () => import("./assets/SeoForm-lQGqoOs_.js"), "./Pages/Admin/Core/Pages/Show.vue": () => import("./assets/Show-CEhVnm1C.js"), "./Pages/Admin/Core/Users/Components/UserForm.vue": () => import("./assets/UserForm-DMgyI16o.js"), "./Pages/Admin/Core/Users/Create.vue": () => import("./assets/Create-WJX_uUNU.js"), "./Pages/Admin/Core/Users/Edit.vue": () => import("./assets/Edit-BMFQroFX.js"), "./Pages/Admin/Core/Users/Index.vue": () => import("./assets/Index-KK_10nOP.js"), "./Pages/Admin/Core/Users/Show.vue": () => import("./assets/Show-CgKqXIwT.js"), "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-BAU8eo8P.js"), "./Pages/Admin/Settings/Options.vue": () => import("./assets/Options-CqOhdInz.js"), "./Pages/Admin/Settings/PaymentMethods/Create.vue": () => import("./assets/Create-Cr3NIyiW.js"), "./Pages/Admin/Settings/PaymentMethods/Edit.vue": () => import("./assets/Edit-Bzag0Sy-.js"), "./Pages/Admin/Settings/PaymentMethods/Index.vue": () => import("./assets/Index-BJTT_xDu.js"), "./Pages/Admin/Settings/PaymentMethods/Partials/DataForm.vue": () => import("./assets/DataForm-CdievclL.js"), "./Pages/Admin/Settings/PaymentMethods/Partials/DataTable.vue": () => import("./assets/DataTable-CbJleSDM.js"), "./Pages/Admin/Settings/PaymentMethods/Partials/GeneralForm.vue": () => import("./assets/GeneralForm-DzpfQfJM.js"), "./Pages/Admin/Settings/PaymentMethods/Partials/TranslationContent.vue": () => import("./assets/TranslationContent-DPs0kTDb.js"), "./Pages/Admin/Settings/Shippings/Edit.vue": () => import("./assets/Edit-CzMWQglm.js"), "./Pages/Admin/Settings/Shippings/Index.vue": () => import("./assets/Index-DNRKspJC.js"), "./Pages/Admin/Settings/Shippings/Partials/DataTable.vue": () => import("./assets/DataTable-ColoMmkD.js"), "./Pages/Admin/Settings/Translations/Form.vue": () => import("./assets/Form-D2ZWmnTT.js"), "./Pages/Admin/Settings/Versions/Form.vue": () => import("./assets/Form-Bo4xuiJ8.js"), "./Pages/Auth/AuthUserForm.vue": () => import("./assets/AuthUserForm-WyAynOwd.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-BopyCHf5.js"), "./Pages/Public/Account/Index.vue": () => import("./assets/Index-CGSVUXbj.js"), "./Pages/Public/Commerce/Cart.vue": () => import("./assets/Cart-CUNyll1f.js"), "./Pages/Public/Commerce/Category.vue": () => import("./assets/Category-DXEsyUpW.js"), "./Pages/Public/Commerce/Categoryold.vue": () => import("./assets/Categoryold-BDD3lzpI.js"), "./Pages/Public/Commerce/Checkout/Index.vue": () => import("./assets/Index-DSfMmHYh.js"), "./Pages/Public/Commerce/Checkout/Partials/OrderSummary.vue": () => import("./assets/OrderSummary-CLW2Cav3.js"), "./Pages/Public/Commerce/Checkout/Steps/StepContact.vue": () => import("./assets/StepContact-LxNsNWtk.js"), "./Pages/Public/Commerce/Checkout/Steps/StepDelivery.vue": () => import("./assets/StepDelivery-BMImZW47.js"), "./Pages/Public/Commerce/Checkout/Steps/StepPayment.vue": () => import("./assets/StepPayment-EvwzxruV.js"), "./Pages/Public/Commerce/Checkout/layout/DefaultCheckoutLayout.vue": () => import("./assets/DefaultCheckoutLayout-Djnvdtym.js"), "./Pages/Public/Commerce/CheckoutOld.vue": () => import("./assets/CheckoutOld-Dj1NjkbU.js"), "./Pages/Public/Commerce/Components/BuyButton.vue": () => import("./assets/BuyButton-DurVeyzU.js"), "./Pages/Public/Commerce/Components/PopularProducts.vue": () => import("./assets/PopularProducts-Cb__eGGT.js"), "./Pages/Public/Commerce/Components/ProductCard.vue": () => import("./assets/ProductCard-Brr9UXw0.js"), "./Pages/Public/Commerce/Components/ProductFilters.vue": () => import("./assets/ProductFilters-BpcXW103.js"), "./Pages/Public/Commerce/Components/ProductFiltersOld.vue": () => import("./assets/ProductFiltersOld-DyrTxorc.js"), "./Pages/Public/Commerce/Components/SkeletonProductCard.vue": () => import("./assets/SkeletonProductCard-0R0RYbYz.js"), "./Pages/Public/Commerce/Components/SortDropdown.vue": () => import("./assets/SortDropdown-DKM1lSKE.js"), "./Pages/Public/Commerce/Components/View/ProductPrice.vue": () => import("./assets/ProductPrice-B0kbdA1m.js"), "./Pages/Public/Commerce/Components/View/QuantitySelector.vue": () => import("./assets/QuantitySelector-DyCV-Jzo.js"), "./Pages/Public/Commerce/Components/View/QuantityStatus.vue": () => import("./assets/QuantityStatus-BjP6BbJj.js"), "./Pages/Public/Commerce/Components/View/StatsRating.vue": () => import("./assets/StatsRating-8EdIqWFW.js"), "./Pages/Public/Commerce/Pagination.vue": () => import("./assets/Pagination-VZqicp2n.js"), "./Pages/Public/Commerce/Partials/ContactInfo.vue": () => import("./assets/ContactInfo-CigWYlzz.js"), "./Pages/Public/Commerce/Partials/PaymentMethods.vue": () => import("./assets/PaymentMethods-BHqJDXf_.js"), "./Pages/Public/Commerce/Partials/ShippingInfo.vue": () => import("./assets/ShippingInfo-Db75YONL.js"), "./Pages/Public/Commerce/View.vue": () => import("./assets/View-BHJG5npD.js"), "./Pages/Public/Commerce/View_.vue": () => import("./assets/View_-Dufdzu4i.js"), "./Pages/Public/Home.vue": () => import("./assets/Home-Cp09oLfH.js"), "./Pages/Public/Index.vue": () => import("./assets/Index-BEgMP-y2.js"), "./Pages/Public/Old.vue": () => import("./assets/Old-Bo8R1vmG.js"), "./Pages/Public/PageShow.vue": () => import("./assets/PageShow-BTGaSfro.js"), "./Pages/Public/Search.vue": () => import("./assets/Search-DRAUa-Bj.js") })
    ),
    setup({ App: App2, props, plugin: plugin2 }) {
      ...
      }).use(pinia).use(head).use(Gt).use(helper).component("Head", head_default).component("Link", link_default);
    }
  })
);
export {
  loadLanguageAsync as a,
  usePage as b,
  head_default as h,
  link_default as l,
  trans as t,
