...
class ReviewController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            $reviewableType = $request->query('model'); // Отримуємо з query string
            $reviewableId = (int) $request->query('model_id');

            // Динамічно знаходимо модель
            ...
            return response()->json([
                ...
                'error' => $e->getMessage() // Тимчасово для дебагу
            ], 500);
        }
    }
