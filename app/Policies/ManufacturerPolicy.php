...
class ManufacturerPolicy
{
    ...
    {
        return $user->hasPermissionTo('manufacturer-view');
    }
    ...
    {
        return $user->hasPermissionTo('manufacturer-create');
    }
    ...
    {
        return $user->hasPermissionTo('manufacturer-update');
    }
    ...
    {
        return $user->hasPermissionTo('manufacturer-delete');
    }
