<template>
            ...
            <div class="bg-gray-50 border rounded-lg p-4 md:p-8">
                <div v-if="`title`" class="mb-3">
                    ...
                    <div class="w-full sm:col-span-3">
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Enter the page title. This will appear in search
                            engine results.
                        </p>
                ...
                <div v-if="`description`" class="mb-3">
                    ...
                    <div class="w-full sm:col-span-3">
                        ...
                        />
                        <p class="mt-1 text-xs text-gray-500">
                            Provide a brief description of the page content for
                            SEO purposes.
                        </p>
    ...
    <div
        v-if="`meta_title`"
        class="mt-4 border bg-white p-4 md:p-8 flex rounded-lg"
    >
        <div class="w-full md:w-1/4">
