...
import { IconEdit, IconSearch, IconSettings, IconTrash } from '@tabler/icons-vue';
...
<template>
    <div class="overflow-x-auto border bg-white rounded-lg">
        <table class="w-full text-sm min-w-[500px]">
            <thead>
                <tr class="text-xs uppercase text-thin divide-x">
                    <th class="p-2 w-12">
