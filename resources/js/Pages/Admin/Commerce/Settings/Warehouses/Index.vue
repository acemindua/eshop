...
// Correct routing prefix for the submodule
const model = props.prefix;

// Adapter for the WarehouseController data structure
...
<template>
    <div class="max-w-7xl mx-auto space-y-6">
        <div class="flex flex-col space-y-4">
            <!-- Top Management Service Panel -->
            <div
                class="flex items-center justify-between bg-white border border-slate-200/80 rounded-2xl p-4 shadow-sm"
            >
                <div class="flex items-center space-x-3">
                    <div
                        class="p-2 bg-slate-900 text-white rounded-xl shadow-sm"
                    >
