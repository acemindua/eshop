    ...
    >
        <div class="flex w-full h-full relative">
            ...
            <div class="flex flex-col w-full h-screen overflow-y-auto">
                ...
                >
                    <div class="px-2 md:px-4 lg:px-8 h-full container mx-auto">
                        <div
                ...
                <main class="flex-grow">
                    <AlertMessage />
                    <div
                        class="px-2 md:px-4 lg:px-8 w-full h-full container mx-auto"
                    >
                ...
                >
                    <div class="px-2 md:px-4 lg:px-8 container mx-auto">
                        <p
